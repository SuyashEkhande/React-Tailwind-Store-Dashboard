    ...
    return (
        <div className='grid gap-6'>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                <NextPayoutCard title={"Next payout"} amount={"92,912.23"} orderCount={23} />
                <RevenueCard title={"Amount Pending"} amount={"99,372.20"} orderCount={13} />
                <RevenueCard title={"Amount Processed"} amount={"87,92,512.19"} />
            </div>
        </div>
    )
}
